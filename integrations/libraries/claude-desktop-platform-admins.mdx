...
Set budgets and rate limits per provider directly from the Model Catalog:

<Frame>
  <img src="/images/product/model-catalog/budget-and-limits-set-now.png" width="500" alt="Set Now button on a provider card in the Portkey Model Catalog" />
</Frame>

<Frame>
  <img src="/images/product/model-catalog/budget-and-limits-page-model-catalog.png" width="500" alt="Budget and rate limits configuration panel in the Model Catalog" />
</Frame>
...
<Frame>
  <img src="/images/integrations/analytics-new-gif.gif" alt="Portkey Analytics dashboard showing spend, tokens, and latency broken down by metadata" />
</Frame>
